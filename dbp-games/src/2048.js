...
module.exports = class TwoZeroFourEight {
	constructor(options = {}) {
        ...
        if (!options.embed.title) options.embed.title = 'Gra w 2048';
    ...
    async gameOver(msg) {
        const overTitle =  this.gameBoard.includes('b') ? this.options.embed.winTitle || 'Wyhrana!' : this.options.embed.overTitle;
