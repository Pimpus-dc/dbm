{
  ...
  "actions": [
    ...
    },
    {
      "channel": "0",
      "varName": "",
      "message": "Wysłano na kanał ${slashParams(\"Kanał\")}",
      "buttons": [],
      "selectMenus": [],
      "attachments": [],
      "embeds": [],
      ...
      "buttons": [
        {
          ...
          "actions": [
            ...
            },
            {
              ...
              "varName": "",
              "dataName": "id-tresc-otworzonego-ticket",
              "defaultVal": "`Brak ustawionej wiadomości`",
              "storage": "1",
              ...
              "embeds": [
                {
                  ...
                  "imageUrl": "",
                  "thumbUrl": "",
                  "description": "Pomyślnie stworzono twój ticket!\n<#${tempVars(\"chid\")}>",
                  "fields": [],
                  "author": "",
                  "authorUrl": "",
                  "authorIcon": "",
  ...
  "parameters": [
    ...
    {
      "name": "Treść",
      "description": "Podaj treść ticketa",
      "type": "STRING",
      "required": true,
      "choices": null
    },
